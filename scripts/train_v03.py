...
def main():
    ...
    # generators    
    # netG = generator.GALNet_v3_BASE(in_channels=3, 
    #                               out_channels=3, 
    #                               n_feats=128, 
    #                               n_blocks=[4, 4, 4, 4, 4], 
    #                               norm_type=None, 
    ...
    # netG = generator.GALNet_v3_GR(in_channels=3, 
    #                               out_channels=3, 
    #                               n_feats=128, 
    #                               n_blocks=[4, 4, 4, 4, 4], 
    #                               norm_type=None, 
    ...
    netG = generator.GALNet_v4_DENSE(in_channels=3, 
                                    out_channels=3, 
                                    n_feats=128, 
                                    n_blocks=[4, 4, 4, 4, 4], 
                                    norm_type=None, 
...
def train(cfg, 
    ...
    for cur_iter, data in enumerate(train_loader):
        ...
        out0, out1, out2, out3, out4 = GENERATORS['netG'](blur_img)
         
        gt1 = gt_img * gt_onehot_segmap[:,1:2,:,:]
        out1 = out1 * gt_onehot_segmap[:,1:2,:,:]

        gt2 = gt_img * gt_onehot_segmap[:,2:3,:,:]
        out2 = out2 * gt_onehot_segmap[:,2:3,:,:]

        gt3 = gt_img * gt_onehot_segmap[:,3:4,:,:]
        out3 = out3 * gt_onehot_segmap[:,3:4,:,:]

        gt_list = [gt1, gt2, gt3, gt_img]
        ...
        if cfg.LOSS_VGG_WEIGHT:
            ...
            gen_input_fake = out_list[-1].detach()             
        ...
        if cfg.LOSS_L1_WEIGHT: 
            # coarse
            l1_loss = cri_l1(out0, gt_img) * cfg.LOSS_L1_WEIGHT  
